		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Maintenance Report Fiori App",
									"targetURL": "#comennovipmmaintenance-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comennovipmmaintenance-display": {
								"semanticObject": "comennovipmmaintenance",
								"action": "display",
								"description": "Maintenance Report Fiori App",
								"title": "Maintenance Report Fiori App",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.ennovi.pm.maintenance",
									"url": sap.ui.require.toUrl("com/ennovi/pm/maintenance")
								}
							}
						}
					}
